<?php
    ...
    Route::group(['prefix' => 'api-admin','namespace' => 'Admin','middleware' => 'check_admin_login'], function() {
        ...
        //     Route::get('','AdminNhanvienController@nhanvien')->name('admin.nhanvien.index');

        //     Route::get('delete/{id}','AdminNhanvienController@delete')->name('admin.nhanvien.delete');

        //     Route::get('create','AdminNhanvienController@create')->name('admin.nhanvien.create');
        //     Route::post('create','AdminNhanvienController@store');
    
        //     Route::get('edit/{id}','AdminNhanvienController@edit')->name('admin.nhanvien.edit');
        //     Route::post('edit/{id}','AdminNhanvienController@update');
        // });
        /**
