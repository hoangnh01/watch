...
class AdminProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.product.create', compact('categories','attributeOld','attributes','keywords','keywordOld','country'));
    }
    ...
    public function delete($id)
    {
        ...
        $rating=Rating::where('r_product_id',$id);
        $rating->delete();
        $favourite=UserFavourite::where('uf_product_id',$id);
        $favourite->delete();
