...
class AdminStatisticalController extends Controller
{
    public function index()
    {
        ...
        // laays san pham ban chay trong ngay
        $productPay=Order::with('product:id,pro_name,pro_avatar,pro_price,pro_sale')
        ->groupBy('od_product_id')
        ->selectRaw('count(od_product_id) as total, od_product_id')
