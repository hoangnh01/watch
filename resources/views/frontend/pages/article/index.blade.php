...
@section('content')
    <div class="container">
        <div class="breadcrumb">
            <ul>
                <li >
                    <a href="{{asset('/')}}" title="Home"><span itemprop="title">Trang chủ</span></a>
                </li>
                <li >
                        ...
                        <div class="hot-left">
                            <div class="avatar">
                                <a href="{{ route('get.blog.detail',$articleTop->a_slug.'-'.$articleTop->id) }}" title="" class="image cover">
                                    <img class="lazyload" alt="" src="{{ asset(pare_url_file($articleTop->a_avatar)) }}">
                                </a>
                            </div>
                                ...
                                <div class="top">
                                    <div class="avatar">
                                        <a href="{{ route('get.blog.detail',$item->a_slug.'-'.$item->id) }}" title="" class="image cover">
                                            <img class="lazyload" alt="" src="{{ asset(pare_url_file($item->a_avatar)) }}">
                                        </a>
                                    </div>
