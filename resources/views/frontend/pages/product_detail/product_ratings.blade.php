...
@section('css')
<link rel="stylesheet" href="{{ asset('css/ratings_insights.min.css') }}">
@stop
@section('content')
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li >
                    <a itemprop="url" href="{{ route('get.product.list') }}" title="{{$product->category->c_name}}"><span itemprop="title">{{$product->category->c_name}}</span></a>
                </li>
