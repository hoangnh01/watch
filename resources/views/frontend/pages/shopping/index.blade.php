                ...
                <div class="customer__content">
                    <form class="from_cart_register" action="{{route('post.shopping.pay')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly  name="tst_email" id="email" required="" value="{{ get_data_user('web','email') }}" type="text" value="" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="btn-buy">
                            ...
                            <a href=" {{ route('get.form.pay_online') }} " class="buy1 btn btn-purple {{ \Auth::id() ? '' : 'js-show-login' }}" >
                                Thanh toán online
                            </a>
                        </div>
                    </form>
