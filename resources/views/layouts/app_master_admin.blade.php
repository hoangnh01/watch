    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="{{ asset('/api-admin') }}" class="logo">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <img src="{{ asset(pare_url_file(get_data_user('admins','avatar'))) }}" class="user-image" alt="User Image">
                                <span class="hidden-xs">{{ get_data_user('admins','name') }}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="{{ asset(pare_url_file(get_data_user('admins','avatar'))) }}" class="img-circle" alt="User Image">
                                        <p>
...
{{--                            </li>--}}
            ...
            <footer class="main-footer">
                <div class="pull-right hidden-xs">
                    <b>Giảng Viên Hướng Dẫn:</b> Cô Đoàn Thị Thanh Hằng
                </div>
                <strong>Sinh viên thực hiện: <a href="https://adminlte.io">Nguyễn Hữu Hoàng </a>-</strong> 70DCTT21096
            </footer>
            <!-- Control Sidebar -->
