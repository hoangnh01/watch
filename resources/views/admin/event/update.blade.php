                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px"> <img src="{{ asset(pare_url_file($event->e_banner)) }}" onerror="this.onerror=null;this.src={{asset('/images/no-image.jpg')}};" alt="" class="img-thumbnail" style="width: 100%;height: 250px;"> </div>
