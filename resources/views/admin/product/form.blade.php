                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Giá sản phẩm</label>
                             <input type="number" name="pro_price" value="{{  $product->pro_price ?? old('pro_price',0) }}" class="form-control" data-type="currency" placeholder="15.000.000">
        ...
        <div class="box box-warning">
                        ...
                        @foreach($images as $item)
                            <div class="col-sm-2">
                                <a href="{{ route('admin.product.delete_image', $item->id) }}" style="display: block;">
                                    <img src="{{ asset(pare_url_file($item->pi_slug))  }}" style="width: 100%;height: auto">
                                </a>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="box-body">
                <div class="form-group col-sm-3">
                    ...
                    <select name="pro_country" class="form-control ">
                        <option value="0">__Click__</option>
                            ...
                            <option value="{{ $ct->id }}" {{ ($product->pro_country ?? 0) == $ct->id ? "selected='selected'" : "" }}>
                                {{  $ct->name }}
                            </option>
                            @endforeach
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text"  class="form-control" name="pro_energy" value="{{ $product->pro_energy ?? old('pro_energy') }} " placeholder="Năng lượng">
                </div>
                <div class="form-group col-sm-3">
                    <label for="">Độ chịu nước</label>
                    <input type="text"  class="form-control" name="pro_resistant" value="{{ $product->pro_resistant ?? old('pro_resistant') }}" placeholder="Độ chịu nước">
                </div>
                <div class="form-group col-sm-3">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body block-images">
                <div style="margin-bottom: 10px">
                    <img src="{{ asset(pare_url_file($product->pro_avatar ?? ''))  ?? '/images/no-image.jpg' }}" onerror="this.onerror=null;this.src={{asset('/images/no-image.jpg')}};" alt="" class="img-thumbnail" style="width: 200px;height: 200px;">
                </div>
