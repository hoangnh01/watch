    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Sản phẩm bán chạy trong ngày</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    ...
                    <ul class="products-list product-list-in-box">
                        ...
                        <li class="item">
                            <div class="product-img">
                                <img src="{{ asset(pare_url_file($item->product->pro_avatar)) }}" alt="Product Image">
                            </div>
                            <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">
                                    {{  $item['total'] }} Lượt mua
                                    @if ($item->product->pro_sale)
                                        <span class="label label-warning pull-right" style="text-decoration: line-through;">{{ number_format($item->product->pro_price,0,',','.') }} đ</span>
                                                    @php
                                                        $price = ((100 - $item->product->pro_sale) * $item->product->pro_price)  /  100 ;
                                                    @endphp
                                                    <span class="label label-warning pull-right">{{ number_format($price,0,',','.') }} đ</span>
                                        @else
                                                    {{ number_format($item->product->pro_price,0,',','.') }} vnđ
                                    @endif
                                </a>
                                <span class="product-description">{{ $item->product->pro_name }}</span>
                            </div>
                        </li>
                        @endforeach
                    </ul>
