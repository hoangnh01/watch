...
@section('content')
    ...
    <section class="content-header">
        <h1>Thêm mới xuất sứ sản phẩm</h1>
        <ol class="breadcrumb">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body block-images">
                                    ...
                                    <div style="position:relative;"> <a class="btn btn-primary" href="javascript:;"> Chọn ảnh...
                                            <input type="file" style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=0);opacity:0;background-color:transparent;color:transparent;" name="logo" size="40" class="js-upload"> </a> &nbsp; <span class="label label-info" id="upload-file-info"></span> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
