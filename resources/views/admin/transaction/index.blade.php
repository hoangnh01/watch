                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>Tỉnh/Thành phố: {{$transaction->province->name}} </li>
                                                    <li>Quận/Huyện: {{$transaction->district->name}} </li>
                                                </ul>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <a hidden href="{{ route('admin.action.transaction',['success', $transaction->id]) }}" ><i class="fa fa-ban"></i> Đã bàn giao</a>
                                                        </li>
                                                        <li>
