                            ...
                            @if (isset($articles))
                                    @foreach($articles as $article)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset(pare_url_file($article->a_avatar))  }}" style="width: 80px;height: 80px">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{ route('admin.article.hot', $article->id) }}" class="label label-default">hết hot</a>
                                                @endif
                                            </td>
                                            <td>
