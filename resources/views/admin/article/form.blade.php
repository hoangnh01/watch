        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group ">
                    ...
                    <textarea name="a_content" id="my-editor" class="form-control" cols="5" rows="2" >{{ $article->a_content ?? '' }}</textarea>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body block-images">
                <div style="margin-bottom: 10px">
                    <img src="{{ asset(pare_url_file($article->a_avatar ?? ''))  }}" onerror="this.onerror=null;this.src={{asset('/images/no-image.jpg')}};" alt="" class="img-thumbnail" style="width: 200px;height: 200px;">
                </div>
                <div style="position:relative;">
                    <a class="btn btn-primary" href="javascript:;"> Chọn ảnh...
                        <input type="file" style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=0);opacity:0;background-color:transparent;color:transparent;" name="a_avatar" size="40" class="js-upload">
