                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px"> <img src="{{ asset(pare_url_file($slide->sd_image ?? '')) ?? '/images/no-image.jpg'}}" onerror="this.onerror=null;this.src='/images/no-image.jpg';" alt="" class="img-thumbnail" style="width: 100%;height: 400px;"> </div>
